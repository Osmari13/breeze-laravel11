    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'dblaravel11'),
        ...
        'sigeac_transmandu_tenant' => [
            ...
            'username' => env('DB_TMD_USERNAME', 'root'),
            'password' => env('DB_TMD_PASSWORD', ''),
            'unix_socket' => env('DB_TMD_SOCKET', ''),
            'charset' => env('DB_TMD_CHARSET', 'utf8mb4'),
        ...
        'sigeac_hangar74_tenant' => [
            ...
            'username' => env('DB_H74_USERNAME', 'root'),
            'password' => env('DB_H74_PASSWORD', ''),
            'unix_socket' => env('DB_H74_SOCKET', ''),
            'charset' => env('DB_H74_CHARSET', 'utf8mb4'),
